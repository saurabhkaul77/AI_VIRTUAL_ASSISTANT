...
function Customize2() {
  ...
  return (
    <div className='w-full h-screen bg-linear-to-t from-[black] to-[#17225d] flex justify-center items-center flex-col p-[20px]  relative'>
        ...
        {assistantName && <button className='min-w-[300px] h-[60px] mt-[30px] 
            ...
            rounded-full text-[18px]' disabled={loading} onClick={()=>{                
